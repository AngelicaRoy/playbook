...
console.log(myPet1) // un objeto de la clase Pet  Pet {}
...
const carloStudent = new Student("Ana", 12, ["NodeJs", "Python"])
console.log("Ejemplo 3: Instanciar un objeto con atributos")
console.log(carloStudent)
/*
Student {name: 'Ana', age: 12, subjects: Array(2)}
age: 12
name: "Carlo"
subjects: (2) ['NodeJs', 'Python']
*/
...
//Ejemplo 5: Atributos con valores por default
//This PR is in the repo: LaunchX (status: OPEN) and was created on Sun Apr 17 2022 11:27:36 GMT-0500 (hora de verano central)

// Puedes instanciar n cantidad de objetos de la misma clase
const myPR2 = new PullRequest("LaunchX", "Mi segundo PR", 99)
console.log(myPR2.getInfo())
//This PR is in the repo: LaunchX (status: OPEN) and was created on Sun Apr 17 2022 11:29:09 GMT-0500 (hora de verano central)
...
console.log(missionCommanderNode.getStudents) // 0 
console.log(missionCommanderNode.getLives)// 0 
...
console.log(Toolbox.getMostUsefulTools())//['Command line', 'git', 'Text Editor']
...
//Developer {name: 'Carlo', mainLang: 'js', stack: Array(3)}
...
//LaunchXStudent {name: 'Carlo', mainLang: 'js', stack: Array(3)}
...
/*
Ejemplo 10: Overrinding methods
Viajero {name: 'Carlo', username: 'LaunchX', mission: 'Node JS', cycle: 'Abril 2022'}cycle: "Abril 2022"mission: "Node JS"name: "Carlo"username: "LaunchX"[[Prototype]]: Explorer
